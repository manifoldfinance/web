...
import { Box, Button, Flex, Text } from '@modulz/design-system';
    ...
    <Carousel css={{ position: 'relative', pt: '$7' }}>
      ...
      >
        <Flex css={{ ai: 'flex-start', pl: '$5', float: 'left' }}>
          ...
          <CarouselSlide>
            <Tweet
              avatar="https://pbs.twimg.com/profile_images/1447271927765245961/b-WNHt8Z_400x400.jpg"
              url="https://twitter.com/hasufl/status/1384281908637360136"
              author="Hasu"
              username="@hasufl"
            >
              Still think Flashbots ⚡️🤖 should have been called,{' '}
              <Text variant="blue" css={{ display: 'inline' }}>
                @OpenMEV
              </Text>{' '}
              has been the most ergonomic and enjoyable. Took a look at the
              roadmap and it looks like it’s getting even better.
            </Tweet>
          </CarouselSlide>
          <CarouselSlide>
            <Tweet
            ...
            >
              I have been maintainer of SUIT CSS, worked on design systems at
              scale when we still called them Styleguide, created a couple of
              CSS in JS libs and watched this space for a long while and{' '}
              <Text variant="blue" css={{ display: 'inline' }}>
                @stitchesjs
              </Text>{' '}
          ...
          <CarouselSlide>
            <Tweet
              ...
              username="accezr"
            >
              I've been using Stitches + Radix to build a base component library
              for our Design System and I have to say that I'm loving the
              development experience. Thanks to{' '}
              <Text variant="blue" css={{ display: 'inline' }}>
                @modulz
              </Text>{' '}
          ...
          <CarouselSlide>
            ...
            >
              ...
              crew IS without a DOUBT the most devoted crew I've seen. NEVER
              have I seen a team respond to a bug report, in a CANARY build, via
              a discord channel and had the issue resolved by a maintainer in
              &lt; 10 minutes. 🤯{' '}
              <Text variant="blue" css={{ display: 'inline' }}>
                @jon_neal
              </Text>
          ...
          <CarouselSlide>
            ...
            >
              ...
              , the penny finally dropped for me. They've designed an API that
              feels like it belongs in the options panel of a design tool
              because, of course, they're also building{' '}
              <Text variant="blue" css={{ display: 'inline' }}>
                @modulz
              </Text>
              .
          ...
          <CarouselSlide>
            ...
            >
              ...
              for a week on an actual product and I've never had such a smooth
              collaboration, shared vocabulary, and mutual understanding with
              our designer. Setting up tokens and being very systematic and
              constrained about the UI we build has never been easier.
            </Tweet>
          </CarouselSlide>
          <CarouselSlide>
            <Tweet
              ...
              username="msanromanv"
            >
              This definitely feels like a step forward, not only because of the
              performance benefits, SSR support, etc., but the developer
          ...
          <CarouselSlide>
            ...
            >
              Something I don't see very often in any tech or product reading:
              developer &amp; debug experience! It's this focus on using tech as
              a tool and putting humans first that makes products successful.{' '}
              <Text variant="blue" css={{ display: 'inline' }}>
                @stitchesjs
              </Text>{' '}
          ...
          <CarouselSlide>
            <Tweet
              ...
              username="1stfloor"
            >
              The cool thing for me as a designer was seeing the systematic
              approach to using design tokens at a level I could understand 😂 I
              believe the gap between design and development is finally
              narrowing and solutions like Stitches and Modulz speed up this
              process.
            </Tweet>
          </CarouselSlide>
          {/* <CarouselSlide>
          ...
          <CarouselSlide>
            <Tweet
              ...
              username="joebell_"
            >
              Stitches pretty much ticks everything off on my CSS-in-JS wish
              list. I couldn't go back to writing CSS without it.
            </Tweet>
          </CarouselSlide>
          <CarouselSlide>
            <Tweet
            ...
            >
              ...
              convert now. This is just a superior way of writing css-in-js, and
          ...
          <CarouselSlide>
            ...
            >
              This might be the best implementation of CSS-in-JS yet. It does
              what CSS-in-JS has always failed to do in the past: fix all the
              problems that CSS had already solved (and Sass).
            </Tweet>
          </CarouselSlide>
          <CarouselSlide>
            <Tweet
          ...
          <CarouselSlide>
            ...
            >
              ...
              . Creating a design system with strong TypeScript support and ease
              of extension has never been easier. Great job{' '}
              <Text variant="blue" css={{ display: 'inline' }}>
                @peduarte
              </Text>{' '}
              and team! 🚀
          ...
          <CarouselSlide>
            ...
            >
              ...
              <br />
              <br />
              The performance promises and type-hinting make it really appealing
              right away. Good docs as well.
            </Tweet>
          </CarouselSlide>
          <CarouselSlide>
            <Tweet
            ...
            >
              ...
              is the best. Now I'm pretty sure every CSS in JS libs should have
              a (static) variants API as a 1st-class citizen.
            </Tweet>
          </CarouselSlide>
          {/* <CarouselSlide>
            <Tweet
          ...
          <CarouselSlide>
            <Tweet
              ...
              username="areaweb"
            >
              I must say, really impressed by how neat and well-thought is the
              API of{' '}
              <Text variant="blue" css={{ display: 'inline' }}>
                @stitchesjs
              </Text>{' '}
          ...
          <CarouselSlide>
            ...
            >
              This is 🔥 from the docs you can already see how helpful this is
              for designing component libraries with great system design
              definitions.
            </Tweet>
          </CarouselSlide>
          <CarouselSlide>
            ...
            >
              ...
              : This whole skeleton component took me like 5 minutes? Including
              all variants. In other CSS-in-JS solutions, this would take ages
              😅
            </Tweet>
          </CarouselSlide>
          <CarouselSlide>
            ...
            >
              Eu tenho faro para identificar tecnologias que se popularizaram:
              gravei sobre Laravel em 2011, sobre Vue em 2015 e Tailwind em
              2020.
              <br />
              <br />
              Algo me diz que{' '}
