  ...
  variants: {
    variant: {
      indigo: {
        ...
        $$outline: 'none',
        $$syntax1: theme.colors.cyanDark8.value,
        $$syntax2: theme.colors.indigo8.value,
        $$syntax3: theme.colors.cyanDark8.value,
        $$syntax4: theme.colors.cyanDark8.value,
      ...
      cyanDark: {
        ...
        $$syntax2: theme.colors.cyanDark7.value,
