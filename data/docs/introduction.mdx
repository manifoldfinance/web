...
**OpenMEV** is built and operated by Manifold Finance. We are working towards the goal of creating a *credibly neutral* block builder such that there won't be a single major builder that *will* threaten consensus on-chain. 
