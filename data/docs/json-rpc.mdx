...
> OpenMEV exposes a JSON-RPC protocol to send transactions/bundles, get
> transaction status updates, cancel transactions, and retrieve ETH network gas
> fees through its backbone platform providing connectivity to providers like
> Flashbots and Eden Network.
