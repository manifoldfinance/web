...
We are also redesigning our initial SDK and libraries. For a example, a reference library, `libsushi` exists. The preliminary code can be found via [https://github.com/manifoldfinance/libsushi](https://github.com/manifoldfinance/libsushi)
