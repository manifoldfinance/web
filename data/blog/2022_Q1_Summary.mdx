...
Q1 Summary Report is published before our Q2 Guidnace report in which we will outline key objectives and milestones that ought to be realized within that fiscal quarter. 
...
### Junk it: OpenMEV inital core logic
...
(NOTE: kdb+ and q now support Python without performance loss, this only came out in March 2022). Furthermore we of course had to develop our own toolin for EVM specifics, below are three libraries written in C and q specifically for making the EVM play nice with kdb+
...
1: The role of CEO at the scaling phase is much different than at the founding/incubation phase. It is much more bizdev oriented.
2: With a high-profile CEO we could have an easier time finding talent, integrations, investors, etc. A social media presence is a must ontop of having industry 'clout'.
...
We are also redesigning our inital SDK and libraries. For a example, a reference library, `libsushi` exists. The preliminary code can be found via [https://github.com/manifoldfinance/libsushi](https://github.com/manifoldfinance/libsushi)
...
[see this *INFORMATIVE* forum post on sushi's forums](https://forum.sushi.com/t/proposal-sushi-is-omakase/9592)


SushiGuard Router Contract
[see this *PROPOSED* forum post on sushi's forums](https://forum.sushi.com/t/proposal-sushiguard-router-contract/9931/2)
...
information from public and private sources that CommodityStream LLC  
and/or Manifold Finance, Inc believes to be reliable, no representation, warranty or
...
circumstances.  All investment strategies and investments i
nvolve risk of loss.  Nothing contained in this website should be 
construed as investment advice. Any reference to an investment’s
